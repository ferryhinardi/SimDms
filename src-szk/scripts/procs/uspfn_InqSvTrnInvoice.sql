alter procedure uspfn_InqSvTrnInvoice
as

declare @TableName varchar(50)
select @TableName = 'SvTrnInvoice'

;with x as (
    select a.CompanyCode
         , a.CompanyName
         --, LastUpdateDate = isnull(( select top 1 LastUpdateDate from SvTrnInvoice where CompanyCode = a.CompanyCode order by LastUpdateDate desc), '1900-01-01' )
