go
if object_id('uspfn_InqHrEmployeeTraining') is not null
	drop procedure uspfn_InqHrEmployeeTraining

go
CREATE procedure uspfn_InqHrEmployeeTraining
as
declare @TableName varchar(50)
select @TableName = 'HrEmployeeTraining'
