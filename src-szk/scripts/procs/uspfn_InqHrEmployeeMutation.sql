go
if object_id('uspfn_InqHrEmployeeMutation') is not null
	drop procedure uspfn_InqHrEmployeeMutation

go
CREATE procedure uspfn_InqHrEmployeeMutation
as
declare @TableName varchar(50)
select @TableName = 'HrEmployeeMutation'
