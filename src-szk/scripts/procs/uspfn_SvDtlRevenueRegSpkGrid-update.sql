...
/****** Object:  StoredProcedure [dbo].[uspfn_SvDtlRevenueRegSpkGrid]    Script Date: 10/6/2015 2:38:33 PM ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Detail Revenue Register SPK for Grid
-- =============================================
ALTER PROCEDURE [dbo].[uspfn_SvDtlRevenueRegSpkGrid] 
(	@Area     varchar(50),
	 @Dealer   varchar(20),
	 @Outlet   varchar(20),
	 @DateFrom datetime,
...
order by JobOrderNo,CompanyCode
