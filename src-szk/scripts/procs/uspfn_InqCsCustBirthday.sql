alter procedure uspfn_InqCsCustBirthday
as

declare @TableName varchar(50)
select @TableName = 'CsCustBirthday'

;with x as (
    select a.CompanyCode
         , a.CompanyName
         , LastUpdateDate = isnull(( select top 1 LastUpdateDate from CsCustBirthday where CompanyCode = a.CompanyCode order by LastUpdateDate desc), '1900-01-01' )
