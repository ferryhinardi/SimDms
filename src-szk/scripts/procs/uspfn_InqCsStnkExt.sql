alter procedure uspfn_InqCsStnkExt
as

declare @TableName varchar(50)
select @TableName = 'CsStnkExt'

;with x as (
    select a.CompanyCode
         , a.CompanyName
         , LastUpdateDate = isnull(( select top 1 LastUpdateDate from CsStnkExt where CompanyCode = a.CompanyCode order by LastUpdateDate desc), '1900-01-01' )
