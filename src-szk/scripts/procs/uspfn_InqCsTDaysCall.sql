alter procedure uspfn_InqCsTDaysCall
as

declare @TableName varchar(50)
select @TableName = 'CsTDayCall'

;with x as (
    select a.CompanyCode
         , a.CompanyName
         , LastUpdateDate = isnull(( select top 1 LastUpdateDate from CsTDayCall where CompanyCode = a.CompanyCode order by LastUpdateDate desc), '1900-01-01' )
