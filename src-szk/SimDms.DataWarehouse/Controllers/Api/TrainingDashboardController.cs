...
namespace SimDms.DataWarehouse.Controllers.Api
{
    public class TrainingDashboardController : BaseController
    {
        ...
        public JsonResult QryToGrid(string area, string dealer, int startYear, int startMonth, int endYear, int endMonth, string outlet, string filter)
        {
            var message = "";
            ...
            try
            {
                ...
                var query = @"exec usprpt_mpTrainingDashboard @AreaCode, @DealerCode, @Start, @End, @Outlet, @Filter";
                var parameters = new[]
                {
                    new SqlParameter("@AreaCode", area),
        ...
        public JsonResult QryToGridNew(string GroupArea, string CompanyCode, int startYear, int startMonth, int endYear, int endMonth, string outlet, string filter)
        {
            var message = "";
            var calendar = new System.Globalization.GregorianCalendar();
            ...
            try
            {
                ...
                var query = @"exec usprpt_mpTrainingDashboardNew @AreaCode, @DealerCode, @Start, @End, @Outlet, @Filter, @GroupNoNew";
                var parameters = new[]
                {
                    new SqlParameter("@AreaCode", GroupArea),
                    new SqlParameter("@DealerCode", ParamDealerCode),
                    new SqlParameter("@Start", startDate),
                    new SqlParameter("@End", endDate),
                    new SqlParameter("@Outlet", outlet),
                    new SqlParameter("@Filter", filter),
                    new SqlParameter("@GroupNoNew", ParamGroupNoNew),
                };
        ...
        public JsonResult Query(string area, string dealer, int startYear, int startMonth, int endYear, int endMonth)
        {
            var message = "";
            var calendar = new System.Globalization.GregorianCalendar();
            ...
            try
            {
                ...
                var query = @"exec usprpt_mpTrainingDashboard @AreaCode, @DealerCode, @Start, @End";
        ...
        public JsonResult QueryNew(string GroupArea, string CompanyCode, int startYear, int startMonth, int endYear, int endMonth)
        {
            var message = "";
            var calendar = new System.Globalization.GregorianCalendar();
            ...
            try
            {
                ...
                var query = @"exec usprpt_mpTrainingDashboardNew @AreaCode, @DealerCode, @Start, @End, @GroupNoNew";
