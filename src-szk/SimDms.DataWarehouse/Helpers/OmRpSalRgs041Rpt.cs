...
{
    public class OmRpSalRgs041Rpt
    {
        private string area, dealer, outlet, salesType, marketModel;
        ...
        public OmRpSalRgs041Rpt(DataSet dataSet, Dictionary<int, string> param, string flName)
        {
        ...
        void printdata(DataRow row)
        {
            ...
            #region Total
            janWs = decimal.Parse(row["ws1"].ToString());
            febWs = decimal.Parse(row["ws2"].ToString());
            marWs = decimal.Parse(row["ws3"].ToString());
            aprWs = decimal.Parse(row["ws4"].ToString());
            mayWs = decimal.Parse(row["ws5"].ToString());
            junWs = decimal.Parse(row["ws6"].ToString());
            julWs = decimal.Parse(row["ws7"].ToString());
            augWs = decimal.Parse(row["ws8"].ToString());
            sepWs = decimal.Parse(row["ws9"].ToString());
            octWs = decimal.Parse(row["ws10"].ToString());
            novWs = decimal.Parse(row["ws11"].ToString());
            decWs = decimal.Parse(row["ws12"].ToString());
            totalWs = janWs + febWs + marWs + aprWs + mayWs + junWs + julWs + augWs + sepWs + octWs + novWs + decWs;

            janWsTtl += decimal.Parse(row["ws1"].ToString());
            febWsTtl += decimal.Parse(row["ws2"].ToString());
            marWsTtl += decimal.Parse(row["ws3"].ToString());
            aprWsTtl += decimal.Parse(row["ws4"].ToString());
            mayWsTtl += decimal.Parse(row["ws5"].ToString());
            junWsTtl += decimal.Parse(row["ws6"].ToString());
            julWsTtl += decimal.Parse(row["ws7"].ToString());
            augWsTtl += decimal.Parse(row["ws8"].ToString());
            sepWsTtl += decimal.Parse(row["ws9"].ToString());
            octWsTtl += decimal.Parse(row["ws10"].ToString());
            novWsTtl += decimal.Parse(row["ws11"].ToString());
            decWsTtl += decimal.Parse(row["ws12"].ToString());


            janWsArea += decimal.Parse(row["ws1"].ToString());
            febWsArea += decimal.Parse(row["ws2"].ToString());
            marWsArea += decimal.Parse(row["ws3"].ToString());
            aprWsArea += decimal.Parse(row["ws4"].ToString());
            mayWsArea += decimal.Parse(row["ws5"].ToString());
            junWsArea += decimal.Parse(row["ws6"].ToString());
            julWsArea += decimal.Parse(row["ws7"].ToString());
            augWsArea += decimal.Parse(row["ws8"].ToString());
            sepWsArea += decimal.Parse(row["ws9"].ToString());
            octWsArea += decimal.Parse(row["ws10"].ToString());
            novWsArea += decimal.Parse(row["ws11"].ToString());
            decWsArea += decimal.Parse(row["ws12"].ToString());
            ...
            janWsAreaJabodetabek += decimal.Parse(row["ws1"].ToString());
            febWsAreaJabodetabek += decimal.Parse(row["ws2"].ToString());
            marWsAreaJabodetabek += decimal.Parse(row["ws3"].ToString());
            aprWsAreaJabodetabek += decimal.Parse(row["ws4"].ToString());
            mayWsAreaJabodetabek += decimal.Parse(row["ws5"].ToString());
            junWsAreaJabodetabek += decimal.Parse(row["ws6"].ToString());
            julWsAreaJabodetabek += decimal.Parse(row["ws7"].ToString());
            augWsAreaJabodetabek += decimal.Parse(row["ws8"].ToString());
            sepWsAreaJabodetabek += decimal.Parse(row["ws9"].ToString());
            octWsAreaJabodetabek += decimal.Parse(row["ws10"].ToString());
            novWsAreaJabodetabek += decimal.Parse(row["ws11"].ToString());
            decWsAreaJabodetabek += decimal.Parse(row["ws12"].ToString());
            ...
            janWsGT += decimal.Parse(row["ws1"].ToString());
            febWsGT += decimal.Parse(row["ws2"].ToString());
            marWsGT += decimal.Parse(row["ws3"].ToString());
            aprWsGT += decimal.Parse(row["ws4"].ToString());
            mayWsGT += decimal.Parse(row["ws5"].ToString());
            junWsGT += decimal.Parse(row["ws6"].ToString());
            julWsGT += decimal.Parse(row["ws7"].ToString());
            augWsGT += decimal.Parse(row["ws8"].ToString());
            sepWsGT += decimal.Parse(row["ws9"].ToString());
            octWsGT += decimal.Parse(row["ws10"].ToString());
            novWsGT += decimal.Parse(row["ws11"].ToString());
            decWsGT += decimal.Parse(row["ws12"].ToString());
            ...
            janRtl = decimal.Parse(row["rt1"].ToString());
            febRtl = decimal.Parse(row["rt2"].ToString());
            marRtl = decimal.Parse(row["rt3"].ToString());
            aprRtl = decimal.Parse(row["rt4"].ToString());
            mayRtl = decimal.Parse(row["rt5"].ToString());
            junRtl = decimal.Parse(row["rt6"].ToString());
            julRtl = decimal.Parse(row["rt7"].ToString());
            augRtl = decimal.Parse(row["rt8"].ToString());
            sepRtl = decimal.Parse(row["rt9"].ToString());
            octRtl = decimal.Parse(row["rt10"].ToString());
            novRtl = decimal.Parse(row["rt11"].ToString());
            decRtl = decimal.Parse(row["rt12"].ToString());
            totalRtl = janRtl + febRtl + marRtl + aprRtl + mayRtl + junRtl + julRtl + augRtl + sepRtl + octRtl + novRtl + decRtl;

            janRtlTtl += decimal.Parse(row["rt1"].ToString());
            febRtlTtl += decimal.Parse(row["rt2"].ToString());
            marRtlTtl += decimal.Parse(row["rt3"].ToString());
            aprRtlTtl += decimal.Parse(row["rt4"].ToString());
            mayRtlTtl += decimal.Parse(row["rt5"].ToString());
            junRtlTtl += decimal.Parse(row["rt6"].ToString());
            julRtlTtl += decimal.Parse(row["rt7"].ToString());
            augRtlTtl += decimal.Parse(row["rt8"].ToString());
            sepRtlTtl += decimal.Parse(row["rt9"].ToString());
            octRtlTtl += decimal.Parse(row["rt10"].ToString());
            novRtlTtl += decimal.Parse(row["rt11"].ToString());
            decRtlTtl += decimal.Parse(row["rt12"].ToString());


            janRtlArea += decimal.Parse(row["rt1"].ToString());
            febRtlArea += decimal.Parse(row["rt2"].ToString());
            marRtlArea += decimal.Parse(row["rt3"].ToString());
            aprRtlArea += decimal.Parse(row["rt4"].ToString());
            mayRtlArea += decimal.Parse(row["rt5"].ToString());
            junRtlArea += decimal.Parse(row["rt6"].ToString());
            julRtlArea += decimal.Parse(row["rt7"].ToString());
            augRtlArea += decimal.Parse(row["rt8"].ToString());
            sepRtlArea += decimal.Parse(row["rt9"].ToString());
            octRtlArea += decimal.Parse(row["rt10"].ToString());
            novRtlArea += decimal.Parse(row["rt11"].ToString());
            decRtlArea += decimal.Parse(row["rt12"].ToString());
            ...
            janRtlAreaJabodetabek += decimal.Parse(row["rt1"].ToString());
            febRtlAreaJabodetabek += decimal.Parse(row["rt2"].ToString());
            marRtlAreaJabodetabek += decimal.Parse(row["rt3"].ToString());
            aprRtlAreaJabodetabek += decimal.Parse(row["rt4"].ToString());
            mayRtlAreaJabodetabek += decimal.Parse(row["rt5"].ToString());
            junRtlAreaJabodetabek += decimal.Parse(row["rt6"].ToString());
            julRtlAreaJabodetabek += decimal.Parse(row["rt7"].ToString());
            augRtlAreaJabodetabek += decimal.Parse(row["rt8"].ToString());
            sepRtlAreaJabodetabek += decimal.Parse(row["rt9"].ToString());
            octRtlAreaJabodetabek += decimal.Parse(row["rt10"].ToString());
            novRtlAreaJabodetabek += decimal.Parse(row["rt11"].ToString());
            decRtlAreaJabodetabek += decimal.Parse(row["rt12"].ToString());
            ...
            janRtlGT += decimal.Parse(row["rt1"].ToString());
            febRtlGT += decimal.Parse(row["rt2"].ToString());
            marRtlGT += decimal.Parse(row["rt3"].ToString());
            aprRtlGT += decimal.Parse(row["rt4"].ToString());
            mayRtlGT += decimal.Parse(row["rt5"].ToString());
            junRtlGT += decimal.Parse(row["rt6"].ToString());
            julRtlGT += decimal.Parse(row["rt7"].ToString());
            augRtlGT += decimal.Parse(row["rt8"].ToString());
            sepRtlGT += decimal.Parse(row["rt9"].ToString());
            octRtlGT += decimal.Parse(row["rt10"].ToString());
            novRtlGT += decimal.Parse(row["rt11"].ToString());
            decRtlGT += decimal.Parse(row["rt12"].ToString());
            totalRtlGT = janRtlGT + febRtlGT + marRtlGT + aprRtlGT + mayRtlGT + junRtlGT + julRtlGT + augRtlGT + sepRtlGT + octRtlGT + novRtlGT + decRtlGT;

            jan += decimal.Parse(row["rt1"].ToString());
            feb += decimal.Parse(row["rt2"].ToString());
            mar += decimal.Parse(row["rt3"].ToString());
            apr += decimal.Parse(row["rt4"].ToString());
            may += decimal.Parse(row["rt5"].ToString());
            jun += decimal.Parse(row["rt6"].ToString());
            jul += decimal.Parse(row["rt7"].ToString());
            aug += decimal.Parse(row["rt8"].ToString());
            sep += decimal.Parse(row["rt9"].ToString());
            oct += decimal.Parse(row["rt10"].ToString());
            nov += decimal.Parse(row["rt11"].ToString());
            dec += decimal.Parse(row["rt12"].ToString());
            ...
            excelReport.SetCellValue(row["ws1"].ToString(), 8 + rowIndex, 0 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt1"].ToString(), 8 + rowIndex, 1 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(janPct.ToString("n2") + "%", 8 + rowIndex, 2 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber);

            excelReport.SetCellValue(row["ws2"].ToString(), 8 + rowIndex, 3 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt2"].ToString(), 8 + rowIndex, 4 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(febPct.ToString("n2") + "%", 8 + rowIndex, 5 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber);

            excelReport.SetCellValue(row["ws3"].ToString(), 8 + rowIndex, 6 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt3"].ToString(), 8 + rowIndex, 7 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(marPct.ToString("n2") + "%", 8 + rowIndex, 8 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber);

            excelReport.SetCellValue(row["ws4"].ToString(), 8 + rowIndex, 9 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt4"].ToString(), 8 + rowIndex, 10 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            ...
            excelReport.SetCellValue(row["ws5"].ToString(), 8 + rowIndex, 12 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt5"].ToString(), 8 + rowIndex, 13 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            ...
            excelReport.SetCellValue(row["ws6"].ToString(), 8 + rowIndex, 15 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt6"].ToString(), 8 + rowIndex, 16 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            ...
            excelReport.SetCellValue(row["ws7"].ToString(), 8 + rowIndex, 18 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt7"].ToString(), 8 + rowIndex, 19 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            ...
            excelReport.SetCellValue(row["ws8"].ToString(), 8 + rowIndex, 21 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt8"].ToString(), 8 + rowIndex, 22 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            ...
            excelReport.SetCellValue(row["ws9"].ToString(), 8 + rowIndex, 24 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt9"].ToString(), 8 + rowIndex, 25 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            ...
            excelReport.SetCellValue(row["ws10"].ToString(), 8 + rowIndex, 27 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt10"].ToString(), 8 + rowIndex, 28 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            ...
            excelReport.SetCellValue(row["ws11"].ToString(), 8 + rowIndex, 30 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt11"].ToString(), 8 + rowIndex, 31 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            ...
            excelReport.SetCellValue(row["ws12"].ToString(), 8 + rowIndex, 33 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
            excelReport.SetCellValue(row["rt12"].ToString(), 8 + rowIndex, 34 + totalDetailWidth, 1, 1, ExcelCellStyle.RightBorderedStandardNumber, true);
        ...
        public void CreateReport(string pserver)
        {
            ...
            excelReport.SetCellValue("WHOLESALE vs RETAIL COMPARATION REPORT ", 0, 0, 1, dealerWidth + indentTitleDesc + indentTitleDesc + 2, ExcelCellStyle.Header);
            ...
            excelReport.SetCellValue("WS", 7, 0 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 1 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 2 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 3 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 4 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 5 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 6 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 7 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 8 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 9 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 10 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 11 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 12 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 13 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 14 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 15 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 16 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 17 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 18 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 19 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 20 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 21 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 22 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 23 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 24 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 25 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 26 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 27 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 28 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 29 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 30 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 31 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 32 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 33 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 34 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("%", 7, 35 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);

            excelReport.SetCellValue("WS", 7, 36 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            excelReport.SetCellValue("RTL", 7, 37 + totalDetailWidth, 1, 1, ExcelCellStyle.CenterBorderedBold);
            ...
            {
                if (row["CompanyName"].ToString()=="SBT SBY")
                {
                    outlet = outlet;
                }
                #region Looping
                ...
                else if (area == row["Area"].ToString() && dealer == row["CompanyName"].ToString() && outlet != row["BranchName"].ToString())
                {
                    #region Satu
                    totalOutlet++;
                    rowIndex++;
                ...
                else if (area == row["Area"].ToString() && dealer != row["CompanyName"].ToString())
                {
                    #region Dua
                    if (parameter[9].ToString() == "1")
                    {
