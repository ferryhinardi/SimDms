var widget = new SimDms.Widget({
    title: 'Live Stock Portal : Buy / Sell Mode (4W)',
    xtype: 'panels',
    toolbars: [
...
widget.render(function () {
    ...
    $("[name=PartNo]").on("change", function () {
        ...
        $.ajax({
            url: 'wh.api/lookupgrid/LoopUpModel',
            data: { PartNo: partNo },
            type: 'POST',
...
function refreshGrid() {
    ...
    widget.kgrid({
        url: "wh.api/inquiry/LiveStockPartDetailTrans",
        name: "pnlResult",
        params: filter,
        selectable: "row",
        serverBinding: true,
...
function exportToExcel() {
    var url = "wh.api/InquiryProd/LiveStockPartTransProd?";
    var filter = widget.serializeObject('pnlFilter');
    var params = ''
