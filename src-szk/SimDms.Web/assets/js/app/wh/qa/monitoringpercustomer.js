var widget = new SimDms.Widget({
    title: 'Generate Monitoring Per Customer',
    xtype: 'panels',
    toolbars: [
...
function exportToExcel() {
    var url = "wh.api/Questionnaire/generateMonitoringPerCust?";
    var filter = widget.serializeObject('pnlFilter'); //$('#CompanyCode option:selected').text()
