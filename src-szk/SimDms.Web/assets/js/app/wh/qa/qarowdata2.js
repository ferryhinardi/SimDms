    ...
    panels: [
        {
            ...
            items: [
                ...
                { type: "span" },
                { name: 'StatusKonsumen', text: 'Status Konsumen', cls: "span4", type: "select", required: true },
                { type: "span" },
...
function exportToExcel() {
    var url = "wh.api/Questionnaire2/generateQaRowData?";
    ...
    else if (filter.StatusKonsumen == '') {
        sdms.info({ type: "warning", text: "Status Konsumen harus dipilih" });
        //if ($errParamExport) $errParamExport.remove();
        //$errParamExport = $('<span style="margin: -10px 0 18px 0;font-size: 12px;font-style: italic;color:#c60f13;">Tanggal akhir tidak boleh lebih besar dari tanggal mulai.</span>').insertBefore('.modal-footer');
    }
