...
widget.render(function () {
    ...
    //widget.post("wh.api/combo/PartSalesFilter", { ProductType: '2W' }, function (result) {
    //    widget.bind({
    //        name: 'Area',
    //        text: '-- SELECT ALL --',
    //        data: result[0],
...
function initComboDealer() {
    $.ajax({
        ...
        url: 'wh.api/combo/ListDealers2W',
        success: function (data) {
...
function refreshGrid() {
    ...
    widget.kgrid({
        ...
        url: "wh.api/inquiry/HistPartSales2W",
        name: "pnlResult",
        params: filter,
        serverBinding: true,
        sort: [
        ...
        columns: [
            ...
            { field: "CustomerName", width: 480, title: "Customer" },
...
function exportToExcel() {
    var url = "wh.api/InquiryProd/GeneratePartSalesData2W?";
    var filter = widget.serializeObject('pnlFilter');
    var params = ''
