...
widget.render(function () {
    widget.post("wh.api/combo/LiveStockArea", function (result) {
        widget.bind({
            name: 'Area',
            text: '-- ALL AREAS --',
            data: result[0],
...
function refreshGrid() {
    ...
    widget.kgrid({
        url: "wh.api/inquiry/LiveStockPart",
        name: "pnlResult",
        params: filter,
        selectable: "row",
        serverBinding: true,
        ...
        onDblClick: function () {
            ...
            widget.kgrid({
                url: "wh.api/inquiry/LiveStockPartDetail",
                name: "pnlResult",
...
function exportToExcel() {
    var url = "wh.api/InquiryProd/LiveStockPartProd?";
    var filter = widget.serializeObject('pnlFilter');
    var params = ''
