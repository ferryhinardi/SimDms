$(document).ready(function () {
    ...
    // widget.setSelect([{ name: "CompanyCode", url: "wh.api/combo/organizations", optionalText: "-- SELECT ALL --" }]);
            ...
            switch (result) {
                ...
                default:
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        data: params,
                        //url: "wh.api/report/InqEmployees?type=list",
                        url: "wh.api/report/InqEmployeesNew?type=list",
                        success: function (data) {
                            if (data.message == "") {
                                location.href = 'wh.api/report/DownloadExcelFile?key=' + data.value + '&filename=PersonalListEmployee';
                            } else {
