...
[assembly: OwinStartup(typeof(SCHEMON.WebServer.Configs.Startup))]
namespace SCHEMON.WebServer.Configs
{
    ...
    public class SimpleAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        {
            //SMSDB db = new SMSDB();
            //Repository<SCHEMON.Models.User> _repo = new Repository<SCHEMON.Models.User>(db);
            //{
            //    SCHEMON.Models.User user = await _repo.FindAsync(u => u.UserId == context.UserName && u.Password == context.Password);
