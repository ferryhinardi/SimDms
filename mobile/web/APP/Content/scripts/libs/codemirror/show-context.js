        ...
        CodeMirror.on(data, 'select', function (completion, hints) {
            ...
            if (information) {
                ...
                if (contextInfo == null) {
                    ...
                    contextInfo.className = 'CodeMirror3-hints-contextInfo'
                ...
                for (var i = 0; i < state.marked.length; i++) {
                    ...
                    if (m == marker) {
                        ...
                        if (m._templateVar == marker._templateVar) {
                            m.className = "CodeMirror3-templates-variable-selected";
                            m.startStyle = "";
                            m.endStyle = "";
                        } else {
                            m.className = "CodeMirror3-templates-variable";
                            m.startStyle = "CodeMirror3-templates-variable-start";
                            m.endStyle = "CodeMirror3-templates-variable-end";
                        }
                    }
                }
                cm.refresh();
        ...
        function install(cm, data, completion) {
            ...
            for (var i = 0; i < markers.length; i++) {
                ...
                var markText = cm.markText(from, to, {
                    className: "CodeMirror3-templates-variable",
                    startStyle: "CodeMirror3-templates-variable-start",
                    endStyle: "CodeMirror3-templates-variable-end",
                    inclusiveLeft: true,
                    inclusiveRight: true,
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                for (var j = 0; j < templates.length; j++) {
                    ...
                    if (startsWith(template.name, text)) {
                        ...
                        var className = "CodeMirror3-hint-template";
