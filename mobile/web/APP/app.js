...
define(['angular', 'angularAMD', 'api/config/routes/1/', 'angular-sanitize', 'angular-animate', 
     'angular-route', 'ui-codemirror',  'xtform', 'ng-moment','ui-bootstrap','angular-resource', 'pickDay','kendo.ext' , 'ng.nv.d3',
    //'handsontable', 'ngMap',  'angular-markdown-text', 'scrollbars', 'sortable', 'angular-form-gen','autofocus',  'prettify','amplify'
    //'dt-plugins','ng-datatable','ngDialog','ngNotify', 'autofields', 'autofields-bootstrap','colorpicker',
    'angular-block-ui', 'ui-utils',  'ng-calendar',  'ngRule', 'pickDay', 'ngHandsontable',  
    'door3css','adapt-strap','adapt-strap.tpl','ng-idle', 'angularModalService' ],


    function (ng, angularAMD, config) { 

        var app = angular.module("app", ['ng', 'ngRoute', 'ngSanitize', 'ngAnimate', 'angularMoment', 'nvd3',
            'ngHandsontable','kendo.directives', 'ui.utils', 'ui.bootstrap', 'xtForm', 'ngIdle', 'ngResource',  'ui.calendar',            
            ...
            //'autofocus','ui.sortable', 'ngMap','fg', 'markdown','ngScrollbars',
