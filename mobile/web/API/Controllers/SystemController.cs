...
namespace eXpressAPI.Controllers
{
    ...
    public class SystemController : DefaultController
    {
        ...
        public string Index()
        {
            return "Welcome to System Configuration";
        }
        ...
        public JsonResult Setup()
        {
            ...
            if (!db1.Menus.Any())
            {
                ...
                string defaultUserId = System.Configuration.ConfigurationManager.AppSettings["config:DefaultUser"].ToString();
                ...
                try
                {
                    ...
                    {
                        var message = (ret.Errors.First().ToString());
