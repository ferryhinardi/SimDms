...
namespace IdentityAdmin.Api.Controllers
{
    ...
    public class AdminPageController : ApiController
    {
        ...
        {
            return new EmbeddedHtmlResult(Request, "Common.Admin.Assets.Templates.index.html", _identityAdminOptions.AdminSecurityConfiguration);
        }
