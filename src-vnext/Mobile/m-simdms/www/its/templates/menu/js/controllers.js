appControllers.controller('menuCtrl', function ($rootScope, $scope, $timeout, $mdUtil, $mdSidenav, $log, $ionicHistory, $state, $ionicPlatform, $mdDialog, $mdBottomSheet, $mdMenu, $mdSelect) {
    ...
    $rootScope.$on('changeUser', function () {
        $scope.InternalUser = window.globalVariable.internalUser;
