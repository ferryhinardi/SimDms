...
(function (angular) {
    ...
    var appLog = angular.module('logToServer', []);

    appLog.service('$log', function ($log) {
    ...
    appLog.factory('$exceptionHandler', function () {
    ...
    appLog.factory('logToServerInterceptor', ['$q', function ($q) {
            var myInterceptor = {
