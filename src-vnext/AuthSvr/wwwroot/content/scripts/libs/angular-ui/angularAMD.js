...
define(function () {
        ...
        */
        if ( config.hasOwnProperty('controllerUrl') ) {
            ...
            if (typeof config.controller === 'undefined') {
                ...
                config.controller = [
                    '$scope', '__AAMDCtrl', '$injector', '$routeParams',
                    function ($scope, __AAMDCtrl, $injector, $routeParams) {
    ...
    AngularAMD.prototype.bootstrap = function (app, enable_ngload, elem) {
        ...
        app.config(
            ['$controllerProvider', '$compileProvider', '$filterProvider', '$animateProvider', '$provide', '$injector',
                function (controllerProvider, compileProvider, filterProvider, animateProvider, provide, injector) {
                // Cache Providers
