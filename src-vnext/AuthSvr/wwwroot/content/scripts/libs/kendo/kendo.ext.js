        ...
        show: function (options) {
            return new $.Deferred(function (deferred) {
                ...
                options = $.extend({
                    ...
                    visible: false,
                    message: "",
                    icon: options.icon || "k-ext-information"
                }, options);

                $(document.body).append(kendo.format("<div id='extAlertDialog' style='position:relative;'><div style='position:absolute;left:10px;top:10px;' class='{0}'></div><div style='display:inline-block;margin-left:45px;margin-top:10px;'>{1}</div></div>", options.icon, options.message));
    ...
    kendo.ui.ExtOkCancelDialog = {
        show: function (options) {
            return new $.Deferred(function (deferred) {
                ...
                $(document.body).append(kendo.format("<div id='extOkCancelDialog' style='position:relative;'><div style='position:absolute;left:10px;top:10px;' class='{0}'></div><div style='display:inline-block;margin-left:45px;margin-top:10px;'>{1}</div></div>", options.icon, options.message));
    ...
    kendo.ui.ExtYesNoDialog = {
        show: function (options) {
            return new $.Deferred(function (deferred) {
                ...
                $(document.body).append(kendo.format("<div id='extYesNoDialog' style='position:relative;'><div style='position:absolute;left:10px;top:10px;' class='{0}'></div><div style='display:inline-block;margin-left:45px;margin-top:10px;'>{1}</div></div>", options.icon, options.message));
...
function Msgbox(m, t, i) {
    if (i === undefined) {
        kendo.ui.ExtAlertDialog.show({ title: t, message: m })
    } else {
        kendo.ui.ExtAlertDialog.show({ title: t, message: m, icon: i })
    }
}