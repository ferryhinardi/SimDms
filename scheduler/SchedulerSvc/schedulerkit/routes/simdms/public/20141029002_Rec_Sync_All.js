...
var TaskName = "EXEC SYNC ALL";
var TaskNo = "20141029003";
...
select 'exec uspfn_spPartSales' as info
GO
exec uspfn_spPartSales
GO
select 'exec uspfn_SyncSvRegisterSpk' as info
GO
exec uspfn_SyncSvRegisterSpk
GO
select 'exec uspfn_SyncPmHstIts' as info
GO
exec uspfn_SyncPmHstIts
GO
select 'exec uspfn_SyncCustDealer' as info
GO
exec uspfn_SyncCustDealer
GO
select 'exec uspfn_SyncCustSzkDetailTrans' as info
GO
exec uspfn_SyncCustSzkDetailTrans
GO
select 'exec uspfn_SyncCsCustomerView' as info
GO
exec uspfn_SyncCsCustomerView
GO
select 'exec uspfn_SyncCsCustomerVehicleView' as info
GO
