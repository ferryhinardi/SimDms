...
namespace SimDms.Absence.Controllers.Api
{
    public class InOutDataController : BaseController
    {
        ...
        public JsonResult QryToGrid(string position, DateTime fromdate, DateTime todate, string filter)
        {
            var message = "";
            ...
            try
            {
                var query = @"exec usprpt_mpInOutDataDealer @DealerCode, @Position, @FromDate, @ToDate, @Outlet, @Filter";
                var parameters = new[]
                {
        ...
        public JsonResult Query(string position, DateTime fromdate, DateTime todate, string filter)
        {
            var message = "";
            var calendar = new System.Globalization.GregorianCalendar();
