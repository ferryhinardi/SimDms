...
namespace SimDms.Absence.Models
{
    ...
    public class HrEmployee
    {
        ...
        public string FamilyCardPhoto { get; set; }
    ...
    public class AttendanceDaily
    {
        ...
        public int? CalcOvertime { get; set; }
        public string Overtime { get; set; }
        public int? CalcLateTime { get; set; }
        public string LateTime { get; set; }
        public int? CalcReturnBeforeTheTime { get; set; }
        public string ReturnBeforeTheTime { get; set; }
    }

    public class AttendanceResume
    {
        public int OnTime { get; set; }
        public int Late { get; set; }
        public int ReturnBeforeTheTime { get; set; }
