...
{
    public class ReportSparepartMonthlyController : BaseController
    {
        public JsonResult Default()
        {
            var user = CurrentUser;
            var listArea = ctx.DealerMapping.Where(m => m.DealerCode == user.CompanyCode).Select(m => new { value = m.GroupNo, text = m.Area }).ToList();
            var listDealer = ctx.DealerMapping.Where(m => m.DealerCode == user.CompanyCode).Select(m => new { value = m.DealerCode, text = "PT. " + m.DealerName }).ToList();

            var area = listArea.Select(p => p.value);
            var dealercode = listDealer.Select(p => p.value);
        ...
        public JsonResult DealerMapping()
        {
            var user = CurrentUser;
            var listDealer = ctx.DealerMapping.Where(m => m.DealerCode == user.CompanyCode).Select(m => new { value = m.DealerCode, text = "PT. " + m.DealerName }).ToList();
            return Json(listDealer);
        }

        public JsonResult BranchMapping()
        {
            var user = CurrentUser;
            var listArea = ctx.DealerMapping.Where(m => m.DealerCode == user.CompanyCode).Select(m => new { value = m.GroupNo, text = m.Area }).ToList();
            var areatext = listArea.Select(m => m.text).FirstOrDefault();
            var listBranch = ctx.GnMstDealerOutletMappings.Where(m => m.DealerCode == user.CompanyCode ).Select(m => new { value = m.OutletCode, text = m.OutletName }).ToList();
            return Json(listBranch);
        }

        public JsonResult ReportSparepartMonthlyGrid()
        {
            string compCode = Request["CompanyCode"];
            string branchCode = Request["BranchCode"];
            string typeOfGoods = Request["TypeOfGoods"];
            string year = Request["Year"];
            string month = Request["Month"];
            string user = CurrentUser.UserId;

            SqlCommand cmd = ctx.Database.Connection.CreateCommand() as SqlCommand;
            cmd.CommandText = "uspfn_spAnalisisBulananLoad";
        ...
        public ActionResult exportExcel(string Area, string Dealer, string Outlet, string SpID, string Year, string AreaText, string DealerText, string OutletText,string Month, string MonthText,string TypeOfGoods, string TypeOfGoodsText)
        {
            ...
            SqlCommand cmd = ctx.Database.Connection.CreateCommand() as SqlCommand;
            cmd.CommandText = "EXEC " + SpID + " '" + Dealer + "','" + Outlet + "','" + TypeOfGoods + "','" + Year + "','" + Month + "','" + CurrentUser.UserId + "'";            
            cmd.CommandTimeout = 360;
            ...
            {
                branchId = "SEMUA BRANCH";
                branchText = "SEMUA BRANCH";
            ...
            foreach (var row in dt1.Rows)
            {
                ...
                ws.Cell("B" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[5];
                ...
                ws.Cell("C" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[6];
                ...
                ws.Cell("D" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[7];
                ...
                ws.Cell("E" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[8];
                ...
                ws.Cell("F" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[9];
                ...
                ws.Cell("G" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[10];
                ...
                ws.Cell("H" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[11];
                ...
                ws.Cell("I" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[12];
                ...
                ws.Cell("J" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[13];
                ...
                ws.Cell("L" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[15];
                ...
                ws.Cell("M" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[16];
                ...
                ws.Cell("P" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[19];
                ...
                ws.Cell("Q" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[20];
                ...
                ws.Cell("R" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[21];
                ...
                ws.Cell("S" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[22];
                ...
                ws.Cell("T" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[23];
                ...
                ws.Cell("U" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[24];
                ...
                ws.Cell("V" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[25];
                ...
                ws.Cell("W" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[26];
                ...
                ws.Cell("X" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[27];
                ...
                ws.Cell("Y" + lastRow).Value = (Convert.ToDecimal(((System.Data.DataRow)(row)).ItemArray[28]));
                ...
                ws.Cell("Z" + lastRow).Value = (Convert.ToDecimal(((System.Data.DataRow)(row)).ItemArray[29]));
                ...
                ws.Cell("AA" + lastRow).Value = (Convert.ToDecimal(((System.Data.DataRow)(row)).ItemArray[30])) ;
                ...
                ws.Cell("AB" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[31];
                ...
                ws.Cell("AC" + lastRow).Value = (Convert.ToDecimal(((System.Data.DataRow)(row)).ItemArray[32]))/100;
                ws.Cell("AC" + lastRow).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right;
                ws.Cell("AC" + lastRow).Style.NumberFormat.Format = "#,##0.0" + " %";
                ...
                ws.Cell("AD" + lastRow).Value = (Convert.ToDecimal(((System.Data.DataRow)(row)).ItemArray[33]))/100;
                ws.Cell("AD" + lastRow).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right;
                ws.Cell("AD" + lastRow).Style.NumberFormat.Format = "#,##0.0" + " %";
                ...
                ws.Cell("AE" + lastRow).Value = (Convert.ToDecimal(((System.Data.DataRow)(row)).ItemArray[34]))/100;
                ws.Cell("AE" + lastRow).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right;
                ws.Cell("AE" + lastRow).Style.NumberFormat.Format = "#,##0.0" + " %";
                ...
                ws.Cell("AF" + lastRow).Value = (Convert.ToDecimal(((System.Data.DataRow)(row)).ItemArray[35]));
                ...
                ws.Cell("AG" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[36];
                ...
                ws.Cell("AH" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[37];
                ...
                ws.Cell("AI" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[38];
                ...
                ws.Cell("AJ" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[39];
                ...
                ws.Cell("AK" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[40];
                ...
                ws.Cell("AL" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[41];
                ...
                ws.Cell("AM" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[42];
                ...
                ws.Cell("AN" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[43];
                ...
                ws.Cell("AO" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[44];
                ...
                ws.Cell("AP" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[45];
                ...
                ws.Cell("AQ" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[46];
                ...
                ws.Cell("AR" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[47];
                ws.Cell("AR" + lastRow).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right;
                ws.Cell("AR" + lastRow).Style.NumberFormat.Format = "#,##0.0";
                ...
                ws.Cell("AS" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[48];
                ...
                ws.Cell("AT" + lastRow).Value = ((System.Data.DataRow)(row)).ItemArray[49];
