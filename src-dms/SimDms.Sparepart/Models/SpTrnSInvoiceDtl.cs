...
{
    [Table("SpTrnSInvoiceDtl")]
    public class SpTrnSInvoiceDtl
    {
        [Key]
        [Column(Order = 1)]
        ...
        public string ExPickingListNo { get; set; }
        public DateTime ExPickingListDate { get; set; }
    ...
    [Table("SpTrnSInvoiceDtlLog")]
    public class SpTrnSInvoiceDtlLog
    {
        [Key]
        [Column(Order=1)]
        public string CompanyCode{ get; set; }
