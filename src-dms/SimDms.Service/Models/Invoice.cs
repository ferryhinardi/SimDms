...
namespace SimDms.Service.Models
{
    ...
    [Table("SvTrnInvoiceCancelView")]
    public class InvoiceCancelView
    {
        [Key]
        [Column(Order = 1)]
        public string CompanyCode { get; set; }
    ...
    public class InvoiceItem
    {
        ...
        public string PartJobNo { get; set; }
        public decimal QtyNK { get; set; }
