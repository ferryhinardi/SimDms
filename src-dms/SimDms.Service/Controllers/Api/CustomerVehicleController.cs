      ...
      /*  public string getData()
        ...
        */
        ...
        public JsonResult LookUpCustomer()
        {
            ...
            var query = string.Format(@"SELECT top 500 CustomerCode , CustomerName, Address1, Address2, Address3, Address4,Address,Status,ContactPhone,	ContactAddress	,ContactName FROM 
			(SELECT a.CustomerCode , a.CustomerName, a.Address1, a.Address2, a.Address3, a.Address4, 
				...
				GROUP BY a.CompanyCode,b.BranchCode,a.CustomerCode, a.CustomerName, a.Address1, a.Address2, a.Address3, a.Address4, a.Status, a.HPNo
			)CST
			WHERE 1=1 {2} 			
                ORDER BY CST.CustomerName ASC
