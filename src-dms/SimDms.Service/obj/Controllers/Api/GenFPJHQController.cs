...
namespace SimDms.Service.Controllers.Api
{
    public class GenFPJHQController : BaseController
    {
        ...
        {
            var item = ctx.Invoices.Find(CompanyCode, BranchCode, ProductType, model.FirstOrDefault().InvoiceNo);
            ...
            try
            {
                ...
                {
                    UpdateInvoice(data.InvoiceNo, taxInvoice.FPJNo, taxInvoice.FPJDate);
                }
        ...
        private void UpdateInvoice(string invoiceNo, string fpjNo, DateTime fpjDate)
        {
