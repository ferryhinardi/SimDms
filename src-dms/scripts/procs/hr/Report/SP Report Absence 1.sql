if object_id('uspfn_abInqAttendanceDaily') is not null
	drop procedure uspfn_abInqAttendanceDaily

go
create procedure uspfn_abInqAttendanceDaily
...
go
exec uspfn_abInqAttendanceDaily @CompanyCode='6006406'
                              , @Department='SALES'
							  , @Position='S'
							  , @Grade='' 
							  , @DateFrom='2013-11-01'
