if object_id('uspfn_abInqAttendanceResume') is not null
	drop procedure uspfn_abInqAttendanceResume

go
create procedure uspfn_abInqAttendanceResume
...
go
exec uspfn_abInqAttendanceResume @CompanyCode='6006406'
                              , @Department='SALES'
							  , @Position='S'
							  , @Grade='' 
							  , @DateFrom='2013-11-01'
