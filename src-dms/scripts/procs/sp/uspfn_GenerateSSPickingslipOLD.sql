--albai 02/07/14  
--remove  DocumentYear in where clause to get New Document Number, refers from uspfn_GnDocumentGetNew   
...
--set @JobOrderNo  = 'SPK/13/012378'      
--set @ProductType = '4W'      
--set @CustomerCode = '1348718'      
--set @TransType  = '23'      
--set @UserID   = 'sa'      
--set @DocDate  = getdate()      
...
--===============================================================================================================================      
INSERT INTO SvTrnSrvItem (CompanyCode, BranchCode, ProductType, ServiceNo, PartNo, PartSeq, DemandQty, SupplyQty, ReturnQty, CostPrice, RetailPrice, TypeOfGoods, BillType, SupplySlipNo, SupplySlipDate, SSReturnNo, SSReturnDate, CreatedBy, CreatedDate, Las
tupdateBy, LastupdateDate, DiscPct)      
SELECT       
 a.CompanyCode      
 , a.BranchCode      
 , a.ProductType      
