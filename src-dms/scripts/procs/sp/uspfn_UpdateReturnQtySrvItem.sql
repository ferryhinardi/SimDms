create procedure uspfn_UpdateReturnQtySrvItem @CompanyCode varchar(15), @BranchCode varchar(15), 
@ProductType varchar(2),  @LastUpdateBy varchar(15), @ReturnNo varchar(25)
as
SELECT 
	a.CompanyCode
	, a.BranchCode
