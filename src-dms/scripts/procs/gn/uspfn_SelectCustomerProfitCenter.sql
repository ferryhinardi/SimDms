...
uspfn_SelectCustomerProfitCenter '6115204', '611520401', '200063129'

--select * from sysUserProfitCenter where UserID='ga'
--select * from gnMstCustomerProfitCenter where CustomerCode='200063129'
--select * from gnMstCustomer where CustomerCode = '200063129'
