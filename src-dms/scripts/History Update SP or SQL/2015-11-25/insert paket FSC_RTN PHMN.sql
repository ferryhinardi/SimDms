...
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 5000', 'PHMN_RTN 5000', '16510-61J00-000', 1, 35000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB5000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 5000', 'PHMN_RTN 5000', '09168M14015-000', 1, 5000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB5000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 5000', 'PHMN_RTN 5000', '99000B10W40N040', 1, 222000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB5000' and BasicModel = @BasicModel		

insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 5000', 'PHMN_FS 5000', '16510-61J00-000', 1, 35000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 5000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 5000', 'PHMN_FS 5000', '09168M14015-000', 1, 5000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 5000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 5000', 'PHMN_FS 5000', '99000B10W40N040', 1, 222000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 5000' and BasicModel = @BasicModel		

insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 20000', 'PHMN_RTN 20000', '16510-61J00-000', 1, 35000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB20000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 20000', 'PHMN_RTN 20000', '09168M14015-000', 1, 5000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB20000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 20000', 'PHMN_RTN 20000', '09482-00740L000', 4, 18200, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB20000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 20000', 'PHMN_RTN 20000', '99000B10W40N040', 1, 222000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB20000' and BasicModel = @BasicModel		

insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 20000', 'PHMN_FS 20000', '16510-61J00-000', 1, 35000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 20000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 20000', 'PHMN_FS 20000', '09168M14015-000', 1, 5000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 20000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 20000', 'PHMN_FS 20000', '09482-00740L000', 4, 18200, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 20000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 20000', 'PHMN_FS 20000', '99000B10W40N040', 1, 222000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 20000' and BasicModel = @BasicModel		
end
...
begin
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 40000', 'PHMN_RTN 40000', '16510-61J00-000', 1, 35000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel	
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 40000', 'PHMN_RTN 40000', '09482-00740L000', 4, 18200, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 40000', 'PHMN_RTN 40000', '13780-61J00-000', 1, 89000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 40000', 'PHMN_RTN 40000', '09168M14015-000', 1, 5000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel			
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 40000', 'PHMN_RTN 40000', '99000B10W40N040', 1, 222000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel			
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 40000', 'PHMN_RTN 40000', '99000B22BFDN000', 2, 28000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 40000', 'PHMN_RTN 40000', '99000B24COLN000', 1, 115000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel			

insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 40000', 'PHMN_FS 40000', '16510-61J00-000', 1, 35000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel	
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 40000', 'PHMN_FS 40000', '09482-00740L000', 4, 18200, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 40000', 'PHMN_FS 40000', '13780-61J00-000', 1, 89000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 40000', 'PHMN_FS 40000', '09168M14015-000', 1, 5000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel			
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 40000', 'PHMN_FS 40000', '99000B10W40N040', 1, 222000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel			
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 40000', 'PHMN_FS 40000', '99000B22BFDN000', 2, 28000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel		
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 40000', 'PHMN_FS 40000', '99000B24COLN000', 1, 115000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel			
end
...
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel	
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 40000', 'PHMN_RTN 40000', '13780B775A0N000', 1, 102400, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel	
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_RTN 40000', 'PHMN_RTN 40000', '09168M14015-000', 1, 5000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel	
...
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel	
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 40000', 'PHMN_FS 40000', '13780B775A0N000', 1, 102400, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel	
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'PHMN_FS 40000', 'PHMN_FS 40000', '09168M14015-000', 1, 5000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel	
...
begin
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_FS 40000', 'WATER PUMP BELT', '17521-54L31-000', 1, 566000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_FS 40000', 'WATER PUMP BELT', '16510-61A31-000', 1, 101600, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_FS 40000', 'WATER PUMP BELT', '09168-14015-000', 1, 7500 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_FS 40000', 'WATER PUMP BELT', '11518-63J10-000', 1, 11600 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_FS 40000', 'WATER PUMP BELT', '09482-00605-000', 4, 59400 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_FS 40000', 'WATER PUMP BELT', '13780-78K00-000', 1, 230600 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel

insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_RTN 40000', 'WATER PUMP BELT', '17521-54L31-000', 1, 566000, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_RTN 40000', 'WATER PUMP BELT', '16510-61A31-000', 1, 101600, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_RTN 40000', 'WATER PUMP BELT', '09168-14015-000', 1, 7500 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_RTN 40000', 'WATER PUMP BELT', '11518-63J10-000', 1, 11600 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_RTN 40000', 'WATER PUMP BELT', '09482-00605-000', 4, 59400 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'ESK_RTN 40000', 'WATER PUMP BELT', '13780-78K00-000', 1, 230600 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel

insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_FS 40000', 'DISC,FRONT BRAKE', '55191-65J00-000', 2, 70100, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_FS 40000', 'DISC,FRONT BRAKE', '55192-50J00-000', 2, 74100, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_FS 40000', 'DISC,FRONT BRAKE', '55200-65J25-000', 1, 1272200 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_FS 40000', 'DISC,FRONT BRAKE', '55201-50J00-000', 4, 35100 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_FS 40000', 'DISC,FRONT BRAKE', '55206-50J00-000', 4, 35100 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_FS 40000', 'DISC,FRONT BRAKE', '55840-65J00-000', 2, 253400 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_FS 40000', 'DISC,FRONT BRAKE', '55211-65J02-000', 2, 1162500 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'FSC 40000' and BasicModel = @BasicModel

insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_RTN 40000', 'DISC,FRONT BRAKE', '55191-65J00-000', 2, 70100, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_RTN 40000', 'DISC,FRONT BRAKE', '55192-50J00-000', 2, 74100, 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_RTN 40000', 'DISC,FRONT BRAKE', '55200-65J25-000', 1, 1272200 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_RTN 40000', 'DISC,FRONT BRAKE', '55201-50J00-000', 4, 35100 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_RTN 40000', 'DISC,FRONT BRAKE', '55206-50J00-000', 4, 35100 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_RTN 40000', 'DISC,FRONT BRAKE', '55840-65J00-000', 2, 253400 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
insert into svMstTaskPart
select CompanyCode, ProductType, BasicModel, 'FBSK_RTN 40000', 'DISC,FRONT BRAKE', '55211-65J02-000', 2, 1162500 , 'C', 'ga', GETDATE(), 'ga', GETDATE() 
from svMstJob where JobType = 'PB40000' and BasicModel = @BasicModel
