if object_id('uspfn_DlrInqMsiV2AllData_SPK') is not null
       drop procedure uspfn_DlrInqMsiV2AllData_SPK

-- =============================================
-- Author:		fhi.
-- Create date: 07-04-2015 modified 04-09-2015
-- Description:	inq suzuki msi v2 all data
-- =============================================
CREATE PROCEDURE [dbo].[uspfn_DlrInqMsiV2AllData_SPK]
	@Area varchar(250),
...
--					srv.CompanyCode,
--					srv.BranchCode,
--					year(srv.JobOrderClosed) PeriodYear,
--					MONTH(srv.JobOrderClosed) PeriodMonth,
...
--				where srvi.TypeOfGoods = '2'
--				and srvi.companycode=@CompanyCode1
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='1'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='2'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='3'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='4'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='5'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='6'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='7'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='8'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='9'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='10'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='11'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				and srvi.branchCode=@BranchCode1
--				and year(srv.JobOrderClosed)=@PeriodYear
--				and MONTH(srv.JobOrderClosed)='12'
--				group by srv.CompanyCode,srv.BranchCode,year(srv.JobOrderClosed),MONTH(srv.JobOrderClosed)
--				)x)
...
--				year(srv.JobOrderClosed) PeriodYear,
--				MONTH(srv.JobOrderClosed) PeriodMonth,
--				count(srvi.serviceNo) sgaInst
--			from svTrnsrvItem srvi	
--			inner join svtrnservice srv on srv.CompanyCode=srvi.CompanyCode 
--				and srv.BranchCode=srvi.BranchCode 
--				and srv.serviceNo=srvi.ServiceNo
--			where srvi.TypeOfGoods = '2'
--			and srvi.companycode=@CompanyCode1
--			and srvi.branchCode=@BranchCode1
--			and year(srv.JobOrderClosed)=@PeriodYear
