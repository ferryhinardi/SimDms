if object_id('uspfn_DlrInqMsiV2ByBranch_SPK') is not null
       drop procedure uspfn_DlrInqMsiV2ByBranch_SPK

-- =============================================
-- Author:		fhi
-- Create date: 07.04.2015 modified by fhi 04092015
-- Description:	inq suzuki msi v2 
-- =============================================
CREATE PROCEDURE [dbo].[uspfn_DlrInqMsiV2ByBranch_SPK] 
	@Area varchar(250),
