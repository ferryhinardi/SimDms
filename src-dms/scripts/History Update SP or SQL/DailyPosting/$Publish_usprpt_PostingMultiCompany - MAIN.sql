...
BEGIN
 ...
 -- Check Otomatis ON/OFF MD-SD have inventory 
	declare @OtomStatus	varchar(1)
	set @OtomStatus = (select ParaValue from gnMstLookUpDtl where CodeID='OTOM')

	if isnull(@OtomStatus,'1') = '1'
		begin
