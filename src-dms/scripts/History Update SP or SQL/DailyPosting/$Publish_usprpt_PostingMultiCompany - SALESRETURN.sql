...
-- Revision-03 : HTO, 23 August 2015
-- -----------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------  DETAIL PROCESS
			 ...
			 -- SD: Update data to table omMstVehicle
				set @sqlString = 'update ' +@DBName+ '..omMstVehicle
										...
										''', TransferOutNo='''+@VTONo+ 
										''', TransferInNo='''+@VTINo+ 
										''', Status=''2'', isActive=''0''  where CompanyCode='''+@curCompanyCode+
						...
						set @sqlString = 'merge into ' +@DBName+ '..omTrInventQtyVehicle as VEH using (values(''' 
										 ...
										 when matched
												 then update set QtyIn  = QtyIn  - SRC.NewQtyIn
															   ...
															   , BeginningAV = BeginningAV - SRC.NewQtyIn
															   , EndingAV    = EndingAV    - SRC.NewQtyOut
