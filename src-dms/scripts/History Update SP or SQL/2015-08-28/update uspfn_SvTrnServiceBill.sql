...
as      
--SELECT @CompanyCode='6641401', @BranchCode='664140101', @ProductType='4W',@ServiceNo= 3064, @BillType='C'
...
declare @PartsDppAmt     decimal	set @PartsDppAmt     = floor(@PartsGrossAmt    - (CASE WHEN @PartsGrossAmt = 0 THEN 0 ELSE @PartsDiscAmt END))
