...
--exec uspfn_omSlsBPKBrowse 6006410,600641001
 SET @QRYTemp = 
  'SELECT Distinct a.BPKNo, a.BPKDate, a.DONo, a.SONo, d.SKPKNo, d.RefferenceNo, a.CustomerCode  , c.CustomerName , a.ShipTo , e.CustomerName as ShipToDsc,
            ...
            Left join ' + dbo.GetDbMD(@CompanyCode, @BranchCode) + '.dbo.gnMstLookUpDtl f on f.CompanyCode = ''' + dbo.GetCompanyMD(@CompanyCode, @BranchCode) + ''' and a.WarehouseCode=f.LookUpValue and f.CodeID=''MPWH''
