...
ALTER procedure [dbo].[usprpt_SvRpReport021V3Web]
	...
	select x.*, case y.IsLocked when 0 then 'P' else 'C' end as GroupType 
	  from (
			select a.CompanyCode, a.BasicModel
				 ...
				 --, convert(varchar, a.JobOrderDate, 113) JobOrderDate  
			 ...
			 --group by a.CompanyCode, a.BasicModel, a.ChassisCode, a.ChassisNo, convert(varchar, a.JobOrderDate, 113) ,a.jobOrderno  
			)x
