...
--select @CompanyCode=N'6114201',@BranchCodeFrom=N'611420100',@BranchCodeTo=N'611420100',@ProfitCenterCode='300',@PeriodFrom='20150701',@PeriodTo='20150731',@ProductType=N'2W',-- @table='1', 
--@nomorfaktur = '0021554441348' 
...
FROM @TblTempDetail a
WHERE ProfitCenter = '200'
AND (SELECT TOP 1 cBranch FROM @TblTempDetail WHERE CompanyCode = a.CompanyCode AND NOMOR_FAKTUR = a.NOMOR_FAKTUR) > 1
