...
alter proc uspfn_CsInqCustBDay
...
--select BirthDate from gnMstCustomer where BirthDate is not null
--select *
--  from CsCustBirthDay a
-- where a.PeriodYear=DATEPART(year, getdate())





 exec uspfn_CsInqCustBDay @CompanyCode=N'6006406',@BranchCode=N'6006406',@DateFrom=11,@DateTo=11,@OutStanding=N'1'
