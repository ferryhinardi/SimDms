...
( function ( $ ) {
    ...
    var defaults = {
        ...
        onFailureFunc  : $.noop, // This is the function to be run when the all validation of form control failed.
    ...
    Validetta.prototype.init = function( e ){
        ...
        else if( that.handler === true ){ 		
			return that.options.onFailureFunc( that, e );
			return false;
		} // if event type is submit and handler is true, break submit
        else{
