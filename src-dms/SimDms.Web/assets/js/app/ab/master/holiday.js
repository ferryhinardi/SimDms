$(document).ready(function () {
    var options = {
        ...
        items: [
            ...
            { name: "ReligionCode", text: "Religion", cls: "span4", type: "select" },
        ],
        toolbars: [
    ...
    widget.render(function () {
        $.post("ab.api/holiday/default", function (result) {
        ...
        widget.select({ selector: "select[name=ReligionCode]", url: "ab.api/combo/lookups/rlgn" });
    });
    ...
    $("#btnDelete").on("click", function () {
        ...
        if (row !== undefined) {
            if (confirm("Anda yakin akan menghapus data ini?")) {
                widget.post("ab.api/holiday/delete", row, function (result) {
                    if (result.success) {
                        $(".main .gl-form").hide();
                        $(".main .gl-grid").show();
                        widget.refreshGrid();
    ...
    $("#btnSave").on("click", function () {
        ...
        if (valid) {
            ...
            widget.post("ab.api/holiday/save", data, function (result) {
                if (result.success) {
                    $(".main .gl-form").hide();
                    $(".main .gl-grid").show();
                    widget.refreshGrid();
