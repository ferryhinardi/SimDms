...
function salesmangrade($scope, $http, $injector) {

    var me = $scope;

    $injector.invoke(BaseController, this, { $scope: me });

    $http.post('its.api/SalesmanGrade/ComboGrade').
    ...
    me.browse = function () {
        var lookup = Wx.blookup({
            name: "GradeEmployeeAllBranchLookup",
            title: "Karyawan",
            manager: MasterITS,
            query: "GradeEmployeeAllBranchLookup",
            columns: [
    ...
    me.save = function () {
        if (me.data.BranchCode == undefined || me.data.EmployeeID == undefined || me.data.Grade == "") {
            MsgBox("Ada data yang belum lengkap");
            return;
        }
        $http.post('its.api/SalesmanGrade/Save', me.data).
    ...
    me.LookupEmployee = function () {
        ...
        var lookup = Wx.blookup({
            ...
            title: "Karyawan",
            manager: MasterITS,
            query: new breeze.EntityQuery.from("EmployeeLookup").withParameters({ branchCode: me.data.BranchCode }),
            columns: [
                { field: "EmployeeID", title: "Kode Karyawan" },
                { field: "EmployeeName", title: "Nama Karyawan" },
            ]
        ...
        panels: [
            {
                ...
                items: [
                    ...
                    { name: "Grade", text: "Grade", cls: "span4", type: "select2", datasource: "dsGrade" },
                ],
            }
