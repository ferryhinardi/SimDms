$(document).ready(function () {
    ...
    var widget = new SimDms.Widget({
        title: "Executive Summary - Working Days",
        xtype: "panels",
        panels: [
            {
                name: "pnlFilter",
    ...
    function refreshData() {
        $.ajax({
            url: "its.api/inquiry/PmExecSummary2", 
            ...
            success: function (result) {
                ...
                $(".CurrentPreviousMonth").text(moment(data.PrevMonthOfCurrDate).format('MMM').toUpperCase() + ' ' + data.PeriodOfPrevMonth)
