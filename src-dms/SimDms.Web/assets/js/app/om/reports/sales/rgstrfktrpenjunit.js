...
function RptRegisterFakturPenjualanUnit($scope, $http, $injector) {
    ...
    me.printPreview = function () {
        $http.post('om.api/ReportSales/ValidatePrintRegisterInvoice', me.data)
                   .success(function (e) {
                       if (e.success) {
                           if (me.data.isBranch == false) {
                               var ReportId = 'OmRpSalRgs004';
                               //var BranchCode = 'branchcode';
                               me.data.BranchCode =''; //untuk sementara
                           }
                           else {
                               var ReportId = 'OmRpSalRgs004HQ';
...
$(document).ready(function () {
    var options = {
        title: "Report Register Faktur Penjualan Unit",
        xtype: "panels",
        toolbars: [
