...
function omPermohonanFakturPolisController($scope, $http, $injector) {
    ...
    me.getLocalBranch = function () {
        $http.post('om.api/PermohonanFakturPolis/loadFPDetailNew', { vChassisCode: me.detail.ChassisCode, vChassisNo: me.detail.ChassisNo, CustomerCode: me.detail.CustomerCode }).
...
$(document).ready(function () {
    var options = {
        title: "Permohonan Faktur Polisi",
        xtype: "panels",
        /*
        toolbars: [
        ...
        panels: [
            ...
            //}
            {
                ...
                items: [
                    ...
                    { name: "FakturPolisiNo", model: "detail.FakturPolisiNo", text: "No Faktur Polisi", cls: "span3", type: "popup", click: "FakturPolisiNo()", disable: "false" },
                    ...
                    { name: "FakturPolisiDate", model: "detail.FakturPolisiDate", text: "Tgl. Faktur Polis", cls: "span3 full", type: 'ng-datepicker', disable: "isStatus" },
                    {
                        ...
                        cls: "span6",
                        items: [
                            { name: "SalesmanCode", model: "detail.SalesmanCode", cls: "span4", disable: "isStatus", required: true, type: "popup", click: "SalesmanCode()" },
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { name: "SKPKTelp2", model: "detail.SKPKTelp2", text: "SKPK No.Telp 2", cls: "span4", disable: "isStatus", required: false },
                        ]
                    },
                    ...
                    { name: "FakturPolisiName2", model: "detail.FakturPolisiName2", text: "", cls: "span6", disable: "isStatus", required: false, show: "data.StatusFaktur == true" },
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { name: "FakturPolisiTelp2", model: "detail.FakturPolisiTelp2", text: "No.Telp 2", cls: "span4", disable: "isStatus", required: false, show: "data.StatusFaktur == true" },
                        ]
                    },
