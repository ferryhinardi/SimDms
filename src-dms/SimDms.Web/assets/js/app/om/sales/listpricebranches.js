...
function ListPriceBrances($scope, $http, $injector) {
    ...
    me.rowToJson = function (data) {
        ...
        returnObj.EffectiveDate = moment(data[15],'DD-MM-YYYY').format('YYYY-MM-DD');
...
$(document).ready(function () {
  ...
  settings1 = {
      data: data,
      colWidths: [190, 40, 150, 45, 90, 80, 90, 90, 80, 90, 80, 75, 80,80, 60,100,60],
      columns: [
        {
            //data: "SalesModelCode"
            type: 'autocomplete',
      ...
      mergeCells: [
        ...
        { row: 0, col: 12, rowspan: 1, colspan: 2, className: "htMiddle" },
        { row: 0, col: 13, rowspan: 2, colspan: 1, className: "htMiddle" },
