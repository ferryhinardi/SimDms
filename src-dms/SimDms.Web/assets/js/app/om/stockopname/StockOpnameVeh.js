...
"use strict";
function StockOpnameVeh($scope, $http, $injector) {
    var me = $scope;
    ...
    me.printPreview = function () {
        ...
        success(function (data, status, headers, config) {
            if (data.success) {
                var statForm = "";
                var statKend = "";
                if (me.data.StatusForm != "-1") {
                    statForm = me.data.StatusForm;
                }
                if (me.data.StatusKendaraan != "-1") {
                    statKend = me.data.StatusKendaraan;
                }

                var yearFrom = 0;
                var yearTo = 0;

                if (me.data.SalesModelYear != "") {
                    yearFrom = parseInt(me.data.SalesModelYear);
                }
                if (me.to.SalesModelYearTo != "") {
                    yearTo = parseInt(me.to.SalesModelYearTo);
                }

                var data = statForm + "," + me.data.WHCode + "," + me.to.WHCodeTo + "," + me.data.SalesModelCode + "," + me.to.SalesModelCodeTo
                + "," + yearFrom + "," + yearTo + "," + me.data.ColorCode + "," + me.to.ColorCodeTo
                + "," + me.data.STHdrNo + "," + me.to.STHdrNoTo + "," + statKend;
                var rparam = "admin";
    ...
    me.initialize = function () {
        ...
        me.data.StatusForm = "-1";
        me.data.StatusKendaraan = "-1";
        me.data.YearF = 1;
        me.data.YearT = 1;
    }
