...
function RptRegisterHarianPenerbitan($scope, $http, $injector) {
    ...
    me.printUploadData = function () {
        var url = "tax.api/Report/UploadDataB?";
    ...
    me.printPajakMasukan = function () {
        ...
        var par = [
                       '4W', me.data.Month, me.data.Year, 1
        ]
            ...
            $http.post('tax.api/report/PrintBukuPembelian', me.data)
                        .success(function (e) {
                            if (e.success) {
                                ...
                                var par = [
                                               '4W', me.data.Year, me.data.Month, profitCenter, filter, 1, order, isBranch, isMultiBranch, isFpjCentral, 1
                                ]
                                var rparam = 'PERIODE : ' + moment(Date.now()).format('DD-MMMM-YYYY');
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { type: "label", text: "Upload Data To eSPT PPN 1107B", cls: "span7 mylabel" },
                        ]
                    },
                    {
                        type: "controls",
