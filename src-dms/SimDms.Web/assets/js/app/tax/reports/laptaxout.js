...
function RptRegisterHarianPenerbitan($scope, $http, $injector) {
    ...
    me.printUploadData = function () {
        var url = "tax.api/Report/UploadDataA?";
    ...
    me.printPajakKeluaran = function () {
        ...
        var par = [
                       '4W', me.data.Month, me.data.Year, 0
        ]
    ...
    me.printBukuPembelian = function () {
        if ((me.data.isSupplier == true && me.data.SupplierCode == '') || (me.data.isBranch == true && me.data.BranchCode1 == '')) {
            ...
            var par = [
                          'companycode', me.data.BranchCode1, '4W', me.data.Year, me.data.Month, profitCenter, filter, 1, order, isMultiBranch, isBranch, isFpjCentral, allBranch
            ]
            var rparam = 'PERIODE : ' + moment(Date.now()).format('DD-MMMM-YYYY');
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { type: "label", text: "Upload Data To eSPT PPN 1107A", cls: "span7 mylabel" },
                        ]
                    },
                    {
                        type: "controls",
                    ...
                    { name: "UnitUsaha", text: "Unit Usaha", cls: "span3", type: "select2", datasource: "UnitUsaha", show: "data.isCheck3 == true" },
                    {
                        text: "Cabang",
                        type: "controls",
