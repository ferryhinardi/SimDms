   ...
   success(function (data, status, headers, config) {
    ...
    me.generateFPJ = function () {
        ...
        if (bChooseProfitCenter == false) {
            ...
            me.griddetail.length == me.grid1.detail.length;
        ...
        if (me.griddetail.length === 0) {
            ...
            if (me.griddetail.length == me.grid1.detail.length) {
                chkAll = true;
                docNo = '';
            }
                        ...
                        if (data.success == false) {
                            if (data.bProcess == false && chkAll == false) {
                                ...
                                if (data.bProcess == true) {
                                    $.post('tax.api/GenTax/GenerateTaxOnline?startDate=' + fromDate + '&fpjDate=' + fpjDate + '&docNo=' + docNo + '&profitCenter=' +
    ...
    me.queryFPJ = function () {
        ...
        $.post('tax.api/GenTax/ValidateQueryFpj?hiddenFromDate=' + fromDate + '&hiddenEndDate=' + endDate + '&fpjDate=' + $('input[name="DateTo"]').val() +
            '&bFPJCentralized=' + bFPJCentralized + '&profitCenter=' + me.ProfitCenter + '&bFPJG=' + $("#bFPJG").is(':checked')).success(function (data, status, headers, config) {
                if (data.message != '') {
    ...
    me.initialize = function () {
        ...
        $.post('tax.api/GenTax/CheckSettingTXOL').success(function (data, status, headers, config) {
            if (data.success == true) {
    ...
    me.grid3 = new webix.ui({
        ...
        view: "wxtable", css:"alternating",
        columns: [
            { id: "BranchCode", header: "Kode Cabang", fillspace: true },
            { id: "ProfitCenter", header: "Profit Center", fillspace: true },
