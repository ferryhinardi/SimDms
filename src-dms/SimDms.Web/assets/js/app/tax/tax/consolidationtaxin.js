...
function taxConsolidationTaxInController($scope, $http, $injector) {
    ...
    me.browse = function () {
        var lookup = Wx.blookup({
            name: "TaxInBrowse",
            title: "Pajak Masukan Per Periode",
            manager: TaxManager,
            query: "TaxInBrowse",
            columns: [
    ...
    me.loadDetail = function (data) {
        $http.post('tax.api/consolidationtaxin/gettaxin', data)
       .success(function (e) {
           me.data = e[0];
           me.loadTableData(me.gridTaxIn, e);
           me.hasChanged = false;
           me.isExsist = true;
       })
       .error(function (e) {
        ...
        $http.post('tax.api/consolidationtaxin/getgrandtotal', data)
       .success(function (e) {
           me.total = e[0];
           me.hasChanged = false;
       })
    ...
    me.supplier = function () {
        var lookup = Wx.blookup({
            ...
            manager: TaxManager,
            query: new breeze.EntityQuery.from("SupplierBrowse").withParameters({ProfitCenter : ""}),
    ...
    me.query = function () {
        $http.post('tax.api/consolidationtaxin/query', me.data)
       .success(function (e) {
           if (e.success) {
               //me.loadDetail(me.data);
               me.loadTableData(me.gridTaxIn, e.taxIn);
    ...
    me.save = function () {
        $http.post('tax.api/consolidationtaxin/save', me.data)
       .success(function (e) {
           if (e.success) {
               MsgBox(e.message);
               me.loadDetail(me.data);
    ...
    me.saveDetail = function () {
        $http.post('tax.api/consolidationtaxin/validateDetail', me.data)
        .success(function (e) {
            if (e.success) {
                        ...
                        if (result) {
                            if (taxNo) {
                                MsgConfirm("No. Seri Pajak kurang atau belum terisi. Lanjut Proses?", function (result) {
                                    if (result) {
                                        $http.post('tax.api/consolidationtaxin/saveDetail', me.data)
                                         .success(function (e) {
                                             if (e.success) {
    ...
    me.deleteDetail = function () {
        MsgConfirm("Hapus Data Detail Pajak, Apakah Anda Yakin ?", function (e) {
            if (e) {
                $http.post('tax.api/consolidationtaxin/deletedetail', me.data)
                .success(function (e) {
                    if (e.success) {
                        me.loadDetail(me.data);
    ...
    me.printPreview = function () {
            Wx.loadForm();
            Wx.showForm({ url: "tax/report/taxinespt" });
    }
    ...
    me.initialize = function () {
        ...
        me.clearTable(me.gridTaxIn);
        me.clearTable(me.gridTaxInHist);
        me.isPrintAvailable = false;
        me.isExsist = false;
    }

    me.gridTaxIn = new webix.ui({
        container: "wxTaxIn",
        ...
        columns: [
            ...
            { id: "SupplierCode", header: "Kode Pemasok", width: 140 },
            { id: "SupplierName", header: "Nama Pemasok", width: 250 },
        ...
        on: {
            onSelectChange: function () {
                if (me.gridTaxIn.getSelectedId() !== undefined) {
                    me.data = this.getItem(me.gridTaxIn.getSelectedId().id);
    ...
    me.gridTaxInHist = new webix.ui({
        container: "wxTaxInHist",
        view: "wxtable", css:"alternating",
        scrollX: true,
        columns: [
            { id: "SeqNo", header: "No.", width: 45 },
            ...
            { id: "SupplierCode", header: "Kode Pemasok", width: 150 },
            { id: "SupplierName", header: "Nama Pemasok", width: 150 },
        ...
        on: {
            onSelectChange: function () {
                if (me.gridTaxInHist.getSelectedId() !== undefined) {
                    me.dtlPart = this.getItem(me.gridTaxInHist.getSelectedId().id);
...
$(document).ready(function () {
    var options = {
        title: "Konsolidasi Pajak Masukan",
        xtype: "panels",
        toolbars: [
            ...
            },
            {
                ...
                items: [
                    { name: "CompanyCode", text: "Kode Perusahaan", cls: "span4", type: "popup", readonly: true, click: "company()" },
                    {
                        ...
                        cls:"span4",
                        items: [
                            { name: "TaxCode", cls: "span2", placeHolder: " ", readonly: true, type: "popup", click: "consolidationLookup('taxin')" },
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { name: "SupplierName", cls: "span6", placeHolder: " ", readonly: true }
                        ]
                    },
                    ...
                    { name: "TaxPeriod", model:'period.TaxPeriod', text: "Masa Pajak", cls: "span4", readonly: true },
    ...
    function init(s) {
        SimDms.Angular("taxConsolidationTaxInController");
    }
});