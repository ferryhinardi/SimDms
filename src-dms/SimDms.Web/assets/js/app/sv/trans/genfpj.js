...
function svGenFPJController($scope, $http, $injector) {
    ...
    me.browse = function () {
        ...
        if (vb == '') {
            ...
            var lookup = Wx.blookup({
                ...
                title: "Faktur Pajak",
                manager: svServiceManager,
                query: new breeze.EntityQuery.from("taxinvoice").withParameters({ docPrefix: docPrefix }),
                columns: [
    ...
    me.loadDetail = function (data) {
        $http.post('sv.api/genfpj/loaddata', {fpjNo : data.FPJNo}).
        success(function (e) {
    ...
    me.query = function () {
        ...
        if (vb == '') {
            ...
            $http.post('sv.api/genfpj/getdata', data)
            .success(function (e) {
                me.loadTableData(me.grid1, e);
    ...
    me.generate = function () {
        ...
        $http.post('sv.api/genfpj/save', JSON.stringify(dat)).
            success(function (e) {
                if(e.success)
                {
                    Wx.Success(e.message);
                    me.loadDetail(e.FPJNo);
                }
            }).error(function (e) {
                MsgBox('Terjadi Kesalahan, Hubungi SDMS Support');
            });
...
$(document).ready(function () {
    var options = {
        title: "Generate Faktur Pajak Gabungan",
        xtype: "panels",
        toolbars: [
    ...
    function init(s) {
        SimDms.Angular("svGenFPJController");
    }
});