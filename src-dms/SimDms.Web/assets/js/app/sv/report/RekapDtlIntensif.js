function RekapIntensifController($scope, $http, $injector) {
    ...
    me.initialize = function () {
        me.hasChanged = false;
        me.data.By = "MK";
        me.data.DateFrom = me.data.DateTo = me.now();
    ...
    me.PrintPreview = function () {
        if (me.data.NIKChk == true && me.data.NIK == undefined) {
            ...
            var ReportId = 'SvRpReport011' + By;

            var par = [
                dateFrom, dateTo, NIK, Nama, Type
            ]
            var rparam = [
                moment(me.data.DateFrom).format('YYYY-MM-DD'),
                moment(me.data.DateTo).format('YYYY-MM-DD'),
                me.UserInfo.UserId,
                (me.NIKChk ? "NIK" : "NAME"),
                ""
            ];
...
$(document).ready(function () {
    var options = {
        title: "Rekapitulasi Perincian Intensif",
        xtype: "panels",
        toolbars: [
        ...
        panels: [
           {
               ...
               items: [
                   ...
                   { name: "DateFrom", cls: "span4", text: "Periode Tanggal", type: "ng-datepicker", required: true },
    ...
    function init(s) {
        SimDms.Angular("RekapIntensifController");
    }
