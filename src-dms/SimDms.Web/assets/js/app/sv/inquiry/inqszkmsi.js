...
function svInqMsIController($scope, $http, $injector) {
    ...
    var params = { id: cpnyCode, jns: "A" }
    $http.post('sv.api/combo/getInqCombo', params)
        .success(function (data, status, headers, config) {
            me.comboArea = data;
            console.log(data);
        });
...
$(document).ready(function () {
    var options = {
        ...
        panels: [
            {
                name: "pnlInqMSI",
                //title: "Suzuki Major Service Indicator (MSI) New",
                items: [
                    {
                        text: "Area",
                        type: "controls",
                        items: [
                            { name: "cmbArea", cls: "span4 full", type: "select2", datasource: "comboArea" },
                        ]
                    },
                    {
                        text: "Dealer",
                        type: "controls",
                        items: [
                            { name: "cmbDealer", cls: "span4 full", type: "select2", click: "DealerCode()", datasource: "comboDealer", disable: "false" },
                        ]
                    },
                    {
                        text: "Branch/Outlet",
                        type: "controls",
                        items: [
                            { name: "cmbOutlet", cls: "span4 full", type: "select2", click: "OutletCode()", datasource: "comboOutlet", disable: "false" },
                        ]
                    },
                    {
                        text: "Year",
                        type: "controls",
                        items: [
                            { name: "Year", cls: "span4 full", type: "select2", datasource: "comboYear" },
                        ]
                    },
                    {
                        text: "Month",
                        type: "controls",
                        items: [
                            { name: "Month", cls: "span4 full", type: "select2", datasource: "comboMonth" },
                        ]
                    },
                     //{ name: "Year", cls: "span4 full", text: "Year", type: "select2", datasource: "comboYear" },
