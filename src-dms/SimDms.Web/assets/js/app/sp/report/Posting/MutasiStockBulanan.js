"use strict"; ////Reportid SpRpTrn019
        ...
        panels: [
            {
                ...
                items: [
                        ...
                        { name: 'Year', model: "data.Years", text: "Kode Cabang", type: "select2", cls: "span2", optionalText: "-- SELECT YEAR --", datasource: "Years" },
