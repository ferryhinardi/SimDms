...
function spLstSalesReturMemo($scope, $http, $injector) {
    ...
    me.ReturLkp = function (x) {
        var lookup = Wx.blookup({
            ...
            manager: spManager,
            query: "SpRptSlsReturNoLkp",
            defaultSort: "ReturnNo asc",
            columns: [
                { field: "ReturnNo", title: "No. Retur" },
                { field: "ReturnDate", title: "Tgl. Retur", template: "#= (ReturnDate== undefined) ? '' : moment(ReturnDate).format('DD MMM YYYY HH:mm:ss') #" },
                { field: "FPJNo", title: "No. Faktur Pajak" },
                { field: "FPJDate", title: "Tgl. Faktur Pajak", template: "#= (FPJDate == undefined) ? '' : moment(FPJDate).format('DD MMM YYYY HH:mm:ss') #" }
            ],
        });
    ...
    me.printPreview = function () {
        var rptid = (me.data.salesType == "0" ? "SpRpTrn012" : "GnRpTrn001");
...
$(document).ready(function () {
        ...
        panels: [
            {
                ...
                items: [                    
                      ...
                      { name: "salesType", model: "data.salesType", text: "", type: "select2", cls: "span4", datasource: 'comboDocOrigin' }
                ]
            }
        ]
    };
    ...
    function init(s) {
        ...
        SimDms.Angular("spLstSalesReturMemo");
