var report = "SpRpRgs010";
"use strict"

function RptRegisterWarehouseTransfer($scope, $http, $injector) {
...
$(document).ready(function () {
    var options = {
        ...
        panels: [
            {
                name: "pnlRegisterWarehouseTransfer",
                items: [
    ...
    function init(s) {
        SimDms.Angular("RptRegisterWarehouseTransfer");
    }
});