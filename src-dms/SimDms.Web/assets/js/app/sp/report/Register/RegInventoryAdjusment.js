var report = "SpRpRgs008";
var isHolding = true;
"use strict"

function RptRegisterInventoryAdjusment($scope, $http, $injector) {
...
$(document).ready(function () {
    var options = {
        title: "Register Inventory Adjusment",
        xtype: "panels",
        toolbars: [
        ...
        panels: [
            {
                name: "pnlRegisterInventoryAdjusment",
                items: [
    ...
    function init(s) {
        SimDms.Angular("RptRegisterInventoryAdjusment");
    }
});