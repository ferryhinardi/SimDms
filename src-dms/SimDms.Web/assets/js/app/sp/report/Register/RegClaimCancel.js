var report = "SpRpRgs015";
"use strict"

function RptRegisterClaimCancel($scope, $http, $injector) {
...
$(document).ready(function () {
    ...
    function init(s) {
        SimDms.Angular("RptRegisterClaimCancel");
    }
});