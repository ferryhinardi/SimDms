var report = "SpRpRgs017A";
"use strict"

function RptRegisterFakturPenjualan($scope, $http, $injector) {
    ...
    me.printPreview = function () {
        var trans = $('#TransType').select2('val') == "" ? "%" : $('#TransType').select2('val');
        ...
        var par = "companycode," + firstPeriod + "," + endPeriod + "," + trans + "," + part;
...
$(document).ready(function () {
    var options = {
        title: "Register Faktur Penjualan (HQ)",
        xtype: "panels",
        toolbars: [
        ...
        panels: [
            {
                name: "pnlRegisterFakturPenjualan",
                items: [
    ...
    function init(s) {
        SimDms.Angular("RptRegisterFakturPenjualan");
    }
});