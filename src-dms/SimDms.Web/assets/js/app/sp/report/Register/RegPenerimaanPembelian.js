var report = "SpRpRgs005";
var isHolding = true;
"use strict"

function RptRegisterPenerimaanPembelian($scope, $http, $injector) {
...
$(document).ready(function () {
    var options = {
        title: "Register Penerimaan Pembeliaan",
        xtype: "panels",
        toolbars: [
        ...
        panels: [
            {
                name: "pnlRegisterPenerimaanPembeliaan",
                items: [
    ...
    function init(s) {
        SimDms.Angular("RptRegisterPenerimaanPembelian");
    }
});