var report = "SpRpRgs012";
"use strict"

function RptRegisterPesananSparepart($scope, $http, $injector) {
...
$(document).ready(function () {
    var options = {
        title: "Register Pesanan Sparepart",
        xtype: "panels",
        toolbars: [
    ...
    function init(s) {
        SimDms.Angular("RptRegisterPesananSparepart");
    }
});