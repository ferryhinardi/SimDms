var report = "SpRpRgs018";
"use strict"

function RptRegisterDetailReturPenjualan($scope, $http, $injector) {
...
$(document).ready(function () {
    var options = {
        title: "Register Detail Retur Penjualan",
        xtype: "panels",
        toolbars: [
    ...
    function init(s) {
        SimDms.Angular("RptRegisterDetailReturPenjualan");
    }
});