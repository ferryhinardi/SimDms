var report = "SpRpRgs030";
"use strict"

function RptRegisterPermohonanSparepart($scope, $http, $injector) {
...
$(document).ready(function () {
    var options = {
        title: "Register Permohonan Sparepart",
        xtype: "panels",
        toolbars: [
    ...
    function init(s) {
        SimDms.Angular("RptRegisterPermohonanSparepart");
    }
});