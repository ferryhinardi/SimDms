...
function spRptLstMstSparePart($scope, $http, $injector) {
    ...
    $http.post('sp.api/Combo/LoadComboData?CodeId=CSCT').
     success(function (data, status, headers, config) {
         me.comboCSCT = data;
     });
...
$(document).ready(function () {
    var options = {
        title: "Daftar Penjualan Per Pelanggan",
        xtype: "panels",
        toolbars: [
        ...
        panels: [
            {
                ...
                items: [
                        ...
                        { name: "Category", model: "data.Category", opt_text: "[SELECT ALL]", cls: "span3 full", disable: "IsEditing() || testDisabled", type: "select2", text: "Category", datasource: "comboCSCT" }
