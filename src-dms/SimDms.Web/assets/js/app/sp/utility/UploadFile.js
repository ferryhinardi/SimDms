...
function spUploadFileController($scope, $http, $injector) {
    var me = $scope;
    $injector.invoke(BaseController, this, { $scope: me });

    $http.post('sp.api/combo/uploadtype')
     .success(function (e) {
    ...
    me.Process = function () {
        ...
        if (me.data.UploadType == undefined || me.data.UploadType == null) {
            ...
            $http.post('sp.api/uploadfile/process', me.data)
            .success(function (e) {
                if (e.success) {
    ...
    me.default = function () {
        $http.post('sp.api/uploadfile/default')
        .success(function (e) {
            if (e.IsBranch) {
                $('#btnProcess').attr('disabled', true);
                $('#btntxtFile').attr('disabled', true);
                me.data.IsBranch = e.IsBranch;
            }
        });
    }
...
$(document).ready(function () {
        ...
        panels: [
             ...
             },
            {
                ...
                items: [
                    ...
                    { name: "IsBranch", text: "All Branch", cls: "span4", type: "x-switch", disable: true},
                    { name: "txtFile", text: "Direktori File ", cls: "span6 ", readonly: true, type: "upload", url: "sp.api/uploadfile/UploadFile", icon: "icon-upload", callback: "uploadCallback", onUpload: "onUpload" },
                    {
    ...
    function init(s) {
        SimDms.Angular("spUploadFileController");
    }
});
