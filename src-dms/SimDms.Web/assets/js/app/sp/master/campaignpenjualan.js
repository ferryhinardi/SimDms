...
function spcampaignPenjualanController($scope, $http, $injector) {
    ...
    me.browse = function () {
        ...
        var lookup = Wx.blookup({
            name: "salescampaignBrowse",
            title: "Sales Campaign Browse",
            manager: spManager,
            query: "mastersalescampaignbrowse",
    ...
    me.saveData = function (e, param) {
        $http.post('sp.api/salescampaign/save', me.data).
    ...
    me.delete = function () {
        MsgConfirm("Are you sure to delete current record?", function (result) {
            if (result) {
                $http.post('sp.api/salescampaign/delete', me.data).
...
$(document).ready(function () {
    var options = {
        title: "Part Campaign for Sales",
        xtype: "panels",
        toolbars:WxButtons,
        panels: [
            {
                name: "pnlPcP",
                title: "Part Campaign Sales",
                items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                { name: "SupplierCode", cls: "span2", readonly: true },
    ...
    function init() {
        SimDms.Angular("spcampaignPenjualanController");
    }
