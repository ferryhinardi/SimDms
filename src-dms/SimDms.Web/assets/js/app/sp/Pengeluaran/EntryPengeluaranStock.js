...
function spEntryPengeluaranStockController($scope, $http, $injector) {
    ...
    $http.post('sp.api/EntryPengeluaranStock/GetLookupEPS_FLAG')
    ...
    me.saveData = function (e, param) {
        console.log(me.selling.TransType);
        var param = {
    ...
    me.StockAllocation = function () {
        ...
        $http.post('sp.api/entrypengeluaranstock/allocationstock', maindata)
        .success(function (e) {
            if (e.success) {
    ...
    me.gridOrderDetailNonSelling = new webix.ui({
        ...
        columns: [
            { id: "No", header: "No", width: 45 },
            { id: "RefferenceNo", header: "WRS No.", fillspace: true },
    ...
    me.start();
    me.jenisTransaksi = "Selling";
}

$(document).ready(function () {
    var options = {
        title: "Entry Pengeluaran Stock",
        xtype: "panels",
        toolbars: WxButtons,
        panels: [
            {
            ...
            },
            {
                ...
                title: "",
                items: [
                        { name: "DocNo", text: "Document No.", cls: "span4", placeHolder: "SOC/XX/YYYYYY", readonly: true },
            ...
            },
            {
                ...
                items: [
                    { name: "nonSellingTransType", model: "nonselling.TransType", text: "Transaction Type", type: "select2", cls: "span4 full", datasource: "comboTTNP" },
                    ...
                    { name: "OrderNo3", model: "nonselling.OrderNo", text: "Order No.", cls: "span4" },
            ...
            },
            {
                ...
                items: [
                            ...
                            { name: "DiscPct", text: "Disc %", value: "0.00", cls: "span4 number", model: 'dtlPart.DiscPct', disable: "enabled == false" },
