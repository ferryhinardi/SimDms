...
function spInquiryItemSparepartHQController($scope, $http, $injector) {
    ...
    me.GetPartInfo = function(partNo)
    {
        ...
        var src = "sp.api/inquiry/DetailOfPartInquiry?HQ=1&PartNo=" + partNo;    
    ...
    me.gridSubsitusi = new webix.ui({
        ...
        columns:[
            ...
            { id: "OnHand", header: "On Hand", width: 100, css: "rightcell", format: me.intFormat },
            { id: "AllocationSP", header: "Allocation SP", width: 100, css: "rightcell", format: me.intFormat },
            { id: "OnOrder", header: "On Order", width: 100, css: "rightcell", format: me.intFormat },
            { id: "InTransit", header: "InTransit", width: 100, css: "rightcell", format: me.intFormat },
            { id: "Received", header: "Received", width: 100, css: "rightcell", format: me.intFormat },
...
$(document).ready(function () {
    var options = {
        title: "Inquiry Item Spareparts (HQ)",
        xtype: "panels",
        panels: [
        {
            name: "pnlA",
    ...
    function init(s) {
        SimDms.Angular("spInquiryItemSparepartHQController"); 
    }
