...
function spInquiryDataDCSController($scope, $http, $injector) {

    var me = $scope;

    $injector.invoke(BaseController, this, { $scope: me });
    me.DataID = [{ "value": "PORDS", "text": "PORDS" }];
    ...
    me.default = function () {
        $http.post('sp.api/InquiryDCSData/Default').
          success(function (e) {
    ...
    me.Retrieve = function () {
        if (!stat) {
            ...
            if (me.data.DataID == undefined || me.data.DataID == null) {
                ...
                $http.post('sp.api/InquiryDCSData/Retrieve', me.data)
                .success(function (e) {
                    console.log(e);
                    if (e.success) {
        ...
        console.log(stat, me.data.DataID,me.data);
    }
...
$(document).ready(function () {
    var options = {
        title: "Inquiry Data DCS (Sparepart)",
        xtype: "panels",
        panels: [
             {
                 name: "pnlA",
    ...
    function init(s) {
        ...
        SimDms.Angular("spInquiryDataDCSController"); 
    }
