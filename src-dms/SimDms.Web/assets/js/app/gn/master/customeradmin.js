...
function gnMasterCustomersController($scope, $http, $injector) {
    ...
    me.saveProfitCenter = function () {
        ...
        if (ret != "") {
            ...
            me.pcmodel.CustomerCode = me.data.CustomerCode;
    ...
    $('#ProfitCenterCode').on('change', function (e) {
        if ($('#ProfitCenterCode').val() == '100') {
            $('#GroupPrice').attr("style", "background-color: rgb(255, 218, 204)");
            $('#btnGroupPrice').removeAttr("style");
            $('#s2id_SalesType').attr("style", "background-color: rgb(255, 218, 204)");
        ...
        panels: [
            {
                ...
                items: [
                    ...
                    { name: "StandardCode", type: "text", text: "Kode Standar", cls: "span4", validasi: "max(15)" }, //, readonly : "data.StandardCode != ''|| (IsEditing() && length(data.StandardCode)<15) "  }, //disable: "data.StandardCode != ''|| (IsEditing() && length(data.StandardCode)<15) "
                    { name: "CustomerAbbrName", text: "Nama Inisial", validasi: "max(15)",cls: "span4"},
                    { name: "isPKP", type: "check", text: "Faktur Pjk Std?", cls: "span4", float: "left", disable: true },
                    ...
                    { name: "HPNo", type: "text", text: "HP No", cls: "span4", validasi: "required", required: true, maxlength : 15 },
                    {
                        name: "CustomerCategory", type: "controls", text: "Kode Kategori", required : true,	items: [
                            { name: "CategoryCode", type: "popup", text: "Category Code", cls: "span3", readonly: true, click: "CategoryCode()", validasi: "required", required: true },
                    ...
                    { name: "NPWPNo", type: "text", type: "ng-maskedit", mask: "##.###.###.#-###.###", text: "NPWP No", cls: "span4", validasi: "required", required: true },
                    { name: "NPWPDate", type: "text", type: "ng-datepicker", text: "NPWP Date", cls: "span4" },
                    ...
                    { name: "SKPDate", type: "ng-datepicker", text: "SKP Date", cls: "span4" },
                    {
                        name: "KodePos", type: "controls", text: "Kode Pos", items: [
                            { name: "ZipNo", type: "popup", text: "Pos Code", cls: "span3", readonly: true, validasi: "required", click: "PosCode()" },
                ...
                items: [
                     {
                         type: "controls", text: "Profit Center", required: true, items: [
                             { name: "ProfitCenterCode", model: "pcmodel.ProfitCenterCode", type: "popup", text: "Profit Center", cls: "span3", readonly: true, click: "ProfitCenterCode()", style: "background-color: rgb(255, 218, 204)" },
                     ...
                     },
                    {
                        type: "controls", text: "Customer Class", required: true, items: [
                            { name: "CustomerClass", model: "pcmodel.CustomerClass", type: "popup", text: "Customer Class", cls: "span3", readonly: true, click: "CustomerClass()", style: "background-color: rgb(255, 218, 204)" },
...

                    {
                        type: "controls", text: "Kode Pajak", required: true, items: [
                            { name: "TaxCode", model: "pcmodel.TaxCode", type: "popup", text: "Tax Code", cls: "span3", click: "TaxCode()", style: "background-color: rgb(255, 218, 204)" },
                    ...
                    },
                    {
                        type: "controls", text: "Kode Trans.Pajak", required: true, items: [
                            { name: "TaxTransCode", model: "pcmodel.TaxTransCode", type: "popup", text: "TaxTrans Code", cls: "span3", click: "TaxTransCode()", maxlength: 3, style: "background-color: rgb(255, 218, 204)" },
                    ...
                    },
                    {
                        type: "controls", text: "Kelompok AR", required: true, items: [
                            { name: "KelAR", model: "pcmodel.KelAR", type: "popup", text: "Group AR", cls: "span3", readonly: true, click: "KelAR()", style: "background-color: rgb(255, 218, 204)" },
                            { name: "KelARDesc", model: "pcmodel.KelARDesc", type: "", text: "Group AR Desc", cls: "span5", readonly: true },
                        ],
                    },
                    { name: "CreditLimit", model: "pcmodel.CreditLimit", text: "Kredit Limit", cls: "span4 number-int", type: "text", placeHolder: "0.00", maxlength: 16 },
                    ...
                    { name: "DiscPct", model: "pcmodel.DiscPct", type: "text", text: "Discount", placeHolder: "0", cls: "span4 number-int", maxlength: 7, style: "background-color: rgb(255, 218, 204)", required: true, },
                    {
...

                    {
                        type: "controls", text: "Labor Discount", show: "pcmodel.ProfitCenterCode=='200'", items: [
                            { name: "LaborDiscPct", model: "pcmodel.LaborDiscPct", type: "text", text: "Labor Discount", placeHolder: "0", cls: "span2 number", maxlength: 7 },
                            { cls: "span1 label-valign", text: "&nbsp;  Diskon Part  &nbsp;", type: "label" },
                            { name: "PartDiscPct", model: "pcmodel.PartDiscPct", type: "text", text: "Part Discount", placeHolder: "0", cls: "span2 number", maxlength: 7 },
                            { cls: "span1 label-valign", text: "&nbsp;  Diskon Material  &nbsp;", type: "label" },
                            { name: "MaterialDiscPct", model: "pcmodel.MaterialDiscPct", type: "text", text: "Material Discount", placeHolder: "0", cls: "span2 number", maxlength: 7 },
                        ],
                    },
                    {
                        type: "buttons",
                ...
                items: [
                     {
                         type: "controls", text: "Profit Center", items: [
                             { name: "ProfitCenterCodeDisc", model: "pdmodel.ProfitCenterCode", text: "Profit Center Code", type: "popup", cls: "span3", readonly: true, required: false, click: "ProfitCenterCodeDisc()", style: "background-color: rgb(255, 218, 204)" },
                     ...
                     },
                    {
                        type: "controls", text: "Type Of Goods", items: [
                            { name: "TypeOfGoodsDisc", model: "pdmodel.TypeOfGoods", text: "Type Of Goods Disc", type: "popup", cls: "span3", readonly: true, required: false, click: "TypeOfGoodsDisc()", style: "background-color: rgb(255, 218, 204)" },
                ...
                items: [
                    {
                        type: "controls", text: "Bank", items: [
                            { name: "BankCode", model: "bkmodel.BankCode", type: "popup", text: "Bank Code", cls: "span3", readonly: true, required: true, click: "BankCode()", style: "background-color: rgb(255, 218, 204)" },
