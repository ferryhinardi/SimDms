...
namespace SimDms.Common.Models
{
    ...
    public class gnMstSupplierClass
    {
        ...
        public string PayableAccNoDesc { get; set; }
        public string DownPaymentAccNoDesc { get; set; }
        public string InterestAccNoDesc { get; set; }
        public string OtherAccNoDesc { get; set; }
        public string TaxInAccNoDesc { get; set; }
        public string WitholdingTaxAccNoDesc { get; set; } 
    }
}